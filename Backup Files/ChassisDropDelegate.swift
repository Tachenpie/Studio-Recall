...
//			
//			Task { @MainActor in
//				// MOVE: existing instanceId present → mutate in place, do NOT create a new instance
...
//					
//					clear(instanceID: instanceId)          // remove from old slots only
//					place(instance, in: range)             // put the SAME instance in new slots
//					
//				} else {
//					// COPY: coming from library/palette → new instance with defaults
